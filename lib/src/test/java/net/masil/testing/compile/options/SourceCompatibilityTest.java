...
import static net.masil.testing.compile.options.SourceCompatibility.OPTION_NAME;
...
class SourceCompatibilityTest {
    ...
    void illegalOptionException() {
        assertThrows(IllegalOptionException.class, () -> SourceCompatibility.of(null));
    }

    @Test
    void setupOption() {
        assertLinesMatch(toList(OPTION_NAME, "1.8"), toList(SourceCompatibility.of("1.8")));
    }
